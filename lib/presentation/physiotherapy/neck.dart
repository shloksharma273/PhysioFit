...
class _NeckState extends State<Neck> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppbar(title: "Neck Exercise"),
            ...
            if (snapshot.data!.snapshot.value != null) {
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    const Text(
                      "Tie the band on your fore head and Push Your Neck SideWays up to 45 degrees",
                      style: TextStyle(
                    ...
                    const Image(image: AssetImage(AppImages.neck
                    )),
